          ...
          <li><a class="nav-link" href="index.php"><i class="far fa-square"></i> <span>Beranda</span></a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="gmaps-simple.html">SPOG</a></li>
                    ...
                    <div class="card-header-form">
                      <form>
                        <div class="input-group">
                          ...
                          <a href="formtambahfaskes.php" class="btn btn-primary" >Tambah Data</a>
                          <a href="cetakfaskes.php" class="btn btn-primary" >Cetak</a>
                        </div>
                      </form>
                    </div>
                  </div>
