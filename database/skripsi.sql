...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2019 at 08:24 AM
...
CREATE TABLE `kecamatan` (
  ...
  `area_kecamatan` varchar(150) DEFAULT NULL,
  `id_kabupaten` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `kecamatan` (`id_kecamatan`, `nama_kecamatan`, `area_kecamatan`, `id_kabupaten`) VALUES
(2, 'Kedaton', '', 3),
(4, 'Kedamaian', '', 3),
(7, 'Bumi Waras', '', 3),
(8, 'Enggal', '', 3),
...
(20, 'Teluk Betung Barat', '', 3),
(21, 'Teluk Betung Selatan', '', 3),
(22, 'Teluk Betung Timur', '', 3),
(23, 'Teluk Betung Utara', '', 3),
(24, 'Way Halim', '', 3);
