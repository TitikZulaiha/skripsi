        ...
        <div class="main-content">
            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="#">Data Faskes</a></div>
                </div>
            </div>
            <?php 
                if(isset($_GET['pesan'])){
                        ...
                        <div class="buttons">
                            <div class="card-header-form">
                                <div class="input-group">
                                    <a href="faskes/coba.php" class="btn btn-primary" ><i class="fas fa-plus"></i> Tambah Data</a>
                            ...
                            <table id="tabelfaskes" class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        include '../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"SELECT * FROM datafaskes INNER JOIN kelurahan ON kelurahan.id_kelurahan = datafaskes.id_faskes");
