    ...
    <div id="app">
        ...
        <div class="main-content">
            ...
            <div class="section-header">
                <h1>Peta Aksesibilitas Seluruh Faskes Ibu dan Anak</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="index.php">Akses Peta</a></div>
                    <div class="breadcrumb-item active"><a href="mapsrumahsakit.php">Peta RS</a></div>
                </div>
            </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Peta Aksesibilitas Seluruh Faskes Ibu dan Anak</h4>
                  </div>
