        ...
        <div class="main-content">
            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="#">Edit Data Kabupaten/a></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            include '../../koneksi.php';
                            $id = $_GET['id'];
                            $data = mysqli_query($koneksi,"select * from kabupaten where id_kabupaten='$id'");
                            while($d = mysqli_fetch_array($data)){
                        ?>
                        <form action="proses_edit.php" method="post">
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Edit Data Kabupaten <small class="text-danger" tyle="font-size:20px">*</small></label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="hidden" class="form-control" name="id_kabupaten" value="<?php echo $d['id_kabupaten']; ?>">
                                        <input type="text" class="form-control" name="nama_kabupaten" value="<?php echo $d['nama_kabupaten']; ?>">
                                    </div>
                            </div>
                            <div class="form-group row mb-4">
