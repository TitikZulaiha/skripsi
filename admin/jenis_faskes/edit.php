                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                            include '../../koneksi.php';
                            $id = $_GET['id'];
                            $data = mysqli_query($koneksi,"select * from datajenis where id_jenis_faskes='$id'");
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Jenis Fasilitas Kesehatan <small class="text-danger" tyle="font-size:20px">*</small></label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="hidden" class="form-control" name="id_jenis_faskes" value="<?php echo $d['id_jenis_faskes']; ?>">
                                        <input type="text" class="form-control" name="jenis_faskes" value="<?php echo $d['jenis_faskes']; ?>">
                                    </div>
                            </div>
                            <div class="form-group row mb-4">
