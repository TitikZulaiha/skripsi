        ...
        <div class="main-content">
            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="mapsbidan.php">Peta Bidan</a></div>
                </div>
            </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="btn-group mb-3 btn-group-sm" role="group" aria-label="Basic example">
                            <a href="persebaran_24jam.php" class="btn btn-primary"></i>Persebaran 24 Jam</a>
                            <a href="persebaran_12jam.php" class="btn btn-primary"></i>Persebaran Selain 24 Jam</a>
                            <a href="aksesibilitas_24jam.php" class="btn btn-primary"></i>Aksesibilitas 24 Jam</a>
                            <a href="aksesibilitas_12jam.php" class="btn btn-primary"></i>Aksesibilitas Selain 24 Jam</a>
                            </div>
            ...
            <form class="form-horizontal" role="form" action="proses_input_jarak_puskes.php" method="post" name="form1">
                ...
                <div id="floating-panel">
                    ...
                    <select id="start">
                        ...
                        $c++;
                        ?>
                        <option value="<?php echo $data['center']?>"> <?php echo $data['nama_kecamatan']; ?></option>
                        <?php } ?>
                    ...
                    <select id="end" name ="end" >
                        ...
                        $c++;
                        ?>
                        <option value="<?php echo $data['alamat']; ?>" rata_rs ="<?php echo $data['rata_puskes'] ?>"><?php echo $data['nama_faskes']; ?></option>
                        <?php } ?>
                        </select>
...
<div class="form-group">
              <input type="hidden" id="data-kecamatan" name="nama_kecamatan" class="form-control"  data-toggle="tooltip" data-placement="bottom" title="Kecamatan" required ="required"> 
            </div>
          </div>
           <div>
       ...
       <!--  <label class="col-sm-2 control-label">End</label> -->
            <div class="col-sm-4">
<div class="form-group">
              <input type="hidden" id="data-puskes" name="nama_faskes" class="form-control"  data-toggle="tooltip" data-placement="bottom" title="Klinik" required ="required"> 
            </div>
          </div> -->
          <div>
            <label class="col-sm-2 control-label">Jarak</label>
            <div class="col-sm-4">
              <input type="text" id="jrk" name="jrk" class="form-control"  data-toggle="tooltip" data-placement="bottom" title="Jarak" required ="required" style = "float: left;
    width: calc(100% - 200px);">
      ...
      <select  id="rata_rs" name = "rata_rs" style="display: none;">
        <?php
        include "koneksi.php";
          $query = "SELECT * FROM datafaskes";
            $result = mysqli_query($query)or die(mysqli_error());
        ...
        $c++;
        ?>
        <option  value="<?php echo $data['rata_rs']; ?>"> <?php echo $data['alamat']; ?></option>
        <?php } ?>
      ...
      <select  id="maxindex" name = "maxindex" style="display: none;">
        ...
        $c++;
        ?>
        <option  value="<?php echo $data['maxindex']; ?>"> <?php echo $data['nama_faskes']; ?></option>
        <?php } ?>
        </select>
      ...
      <select  id="minindex" name = "minindex" style="display: none;">
        ...
        $c++;
        ?>
        <option  value="<?php echo $data['minindex']; ?>"> <?php echo $data['nama_faskes']; ?></option>
        <?php } ?>
        </select>
...
var trafficLayer = new google.maps.TrafficLayer();
      ...
      function calculateAndDisplayRoute(directionsService, directionsDisplay) {
        ...
        // var index =  document.getElementById('end').getAttribute('rata_rs');
        var max = document.getElementById('maxindex').value;
        var min = document.getElementById('minindex').value;
        // var rata_rs = document.getElementsByName('rata_rs').value;
...
// var values = $('#end').val();
        ...
        document.getElementById('data-puskes').value = end;
        // jarak = jarak/1000
        document.getElementById('jrk').value = jarak;
        // document.getElementById('end').getAttribute('rata_rs')+ index;
        document.getElementById('rata_rs').value = rata_rs;
        // document.getElementById('min').value = minindex;
        // document.getElementById('max').value = maxindex;
        // document.getElementById('maxindex').value = max-min;
         // console.log(response.options[0].attributes[0].value.nodeValue);
// $.post('http://localhost/sig_dinkes/ambildata_rs.php', { url: url }, function(data) {
//     document.getElementById('end').innerHTML = data;        
// });
