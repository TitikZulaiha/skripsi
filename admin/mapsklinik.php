    ...
    <div id="app">
        ...
        <div class="main-content">
            ...
            <div class="section-header">
                <h1>DPeta Aksesibilitas Klinik</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="index.php">Akses Peta</a></div>
                    <div class="breadcrumb-item active"><a href="mapsklinik.php">Peta Klinik</a></div>
                </div>
            </div>

            <div class="section-body">
            <h2 class="section-title">Peta Aksesibilitas Klinik</h2>
