...
<head>
    ...
    <title>Peta Aksesibilitas Bidan</title>
        ...
        <div class="main-content">
            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="persebaran_bidan_24jam.php">Peta Bidan</a></div>
                </div>
            </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Peta Persebaran Faskes Bidan 24 Jam</h4>
                  </div>
                  <div class="card-body">
                    <div class="row">
                        <div class="col-4 col-12 col-md-6 col-lg-4">
                            <div class="btn-group mb-3 btn-group-sm" role="group" aria-label="Basic example">
                            <a href="persebaran_bidan_24jam.php" class="btn btn-primary"></i>Persebaran 24 Jam</a>
                            <a href="persebaran_bidan_12jam.php" class="btn btn-primary"></i>Persebaran Selain 24 Jam</a>
                            <a href="persebaran_bidan_12jam.php" class="btn btn-primary"></i>Aksesibilitas 24 Jam</a>
                            <a href="persebaran_bidan_12jam.php" class="btn btn-primary"></i>Aksesibilitas Selain 24 Jam</a>
                            </div>
                            <?php
                                include '../koneksi.php';
                                ?>
                            ...
                            <script type="text/javascript">
                                var markers = [
                                <?php
                                $sql = mysqli_query($koneksi, "SELECT * FROM datafaskes WHERE id_jenis_faskes='1'AND id_jam_buka='2'");
